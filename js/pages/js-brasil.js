...
exports.SOBRENOMES = ['ALMEIDA', 'ALVES', 'ANDRADE', 'BARBOSA', 'BARROS', 'BATISTA', 'BORGES', 'CAMPOS', 'CARDOSO', 'CARVALHO', 'CASTRO',
    'COSTA', 'DIAS', 'DUARTE', 'FREITAS', 'FERNANDES', 'FERREIRA', 'GARCIA', 'GOMES', 'GONÃ‡ALVES', 'LIMA', 'LOPES', 'MACHADO', 'MARQUES', 'MARTINS', 'MEDEIROS',
...
exports.EMPRESAS_TIPOS = ['Pizzaria', 'MecÃ¢nica', 'LaboratÃ³rios', 'Contabilidade', 'Padaria', 'Pastelaria'];
exports.EMPRESAS_NOMES = ['do BarÃ£o', 'UniÃ£o', 'Teixeira', 'Nova Era', 'GenuÃ­no', 'AutÃªntica', 'Lux'];
...
exports.TIPOS_SANGUINEOS = ['O+', 'A+', 'B+', 'AB+', ' Oâˆ’', ' Aâˆ’', ' Bâˆ’', 'ABâˆ’'];
function getAstro(data) {
    ...
    if (month < 1 || month > 12) {
        throw new Error("Mes invÃ¡lido : " + month);
    }
    if (day < 1 || day > 32) {
        throw new Error("Dia invÃ¡lido : " + day);
    }
...
/**
 *
 * @param uf - UF do nÃºmero da guia. Ex: 35(SP), 81(PE)
 * @param ano - ANO do nÃºmero da guia. Ex: 2018, 2019
...
function create_cartaocredito(number) {
    // if (number.length > 18) { alert("Erro. A rotina nÃ£o abrange cartÃµes\ncom mais de 18 dÃ­gitos (fora o DV).\nIntroduza 18 dÃ­gitos, no mÃ¡ximo."); }
...
function create_titulo(titNum) {
    ...
    if (a2 * 10 + a1 == 0 || a2 * 10 + a1 > 28) {
        throw new Error("Esse nÂº Ã© suspeito, porque a identificaÃ§Ã£o da \nUF (Ãºltimos 2 dÃ­gitos) deve estar entre 01 e 28.");
    }
    var titExcecao1 = 0;
    var titExcecao2 = 0;
...
exports.ESTADOS = [
    ...
    { name: 'AmapÃ¡', shortname: 'AP', slug: 'amapa' },
    { name: 'Amazonas', shortname: 'AM', slug: 'amazonas' },
    { name: 'Bahia', shortname: 'BA', slug: 'bahia' },
    { name: 'CearÃ¡', shortname: 'CE', slug: 'ceara' },
    { name: 'Distrito Federal', shortname: 'DF', slug: 'distrito-federal' },
    { name: 'EspÃ­rito Santo', shortname: 'ES', slug: 'espirito-santo' },
    { name: 'GoiÃ¡s', shortname: 'GO', slug: 'goias' },
    { name: 'MaranhÃ£o', shortname: 'MA', slug: 'maranhao' },
    ...
    { name: 'ParÃ¡', shortname: 'PA', slug: 'para' },
    { name: 'ParaÃ­ba', shortname: 'PB', slug: 'paraiba' },
    { name: 'ParanÃ¡', shortname: 'PR', slug: 'parana' },
    { name: 'Pernambuco', shortname: 'PE', slug: 'pernambuco' },
    { name: 'PiauÃ­', shortname: 'PI', slug: 'piaui' },
...
exports.generateInscricaoEstadual = {
    ...
    al: function (valor) {
        ...
        //
        // Removi a validaÃ§Ã£o do tipo da empresa abaixo
        // devido a ambiguidade entre a especificaÃ§Ã£o do
...
function validate_inscricaoestadual(ie, estado) {
    ...
    if (estado !== '' && !(estado in funcoes)) {
        return new Error('estado nÃ£o Ã© vÃ¡lido');
    }
    if (eIndefinido(ie)) {
    ...
    if (!utils_1.allNumbersAreSame(ie)) {
        return new Error('ie com todos dÃ­gitos iguais');
    }
...
/**
 * Ãndice Cadastral, ou inscriÃ§Ã£o imobiliÃ¡ria,  Ã© o nÃºmero de identificaÃ§Ã£o do imÃ³vel no cadastro da Prefeitura de Contagem.
 * O Ã­ndice Ã© composto por 12 (doze) ou 13 (treze) nÃºmeros, sendo: 2 (dois) para a zona fiscal;
 * 3 (trÃªs) ou 4 (quatro) para a quadra fiscal; 4 (quatro) para o lote fiscal; e 3 (trÃªs) para a unidade.
 */
...
exports.MASKS = {
    ...
    // certidao CertidÃµes de Nascimento, Casamento ou Ã“bito 
    certidao: {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.LOCALIZACAO_RUAS = ['Dois', 'Um', 'Principal', 'SÃ£o JosÃ©', 'Onze', 'SÃ£o Paulo', 'Doze', 'Treze',
    'Santo AntÃ´nio', 'Brasil', 'A', 'SÃ£o Pedro', 'Quinze', 'SÃ£o JoÃ£o',
    'Quatorze', 'SÃ£o Francisco', 'Sete de Setembro', 'Dezesseis', 'Quinze de Novembro',
    'Tiradentes', 'Dezessete', 'Vinte', 'Bahia', 'Amazonas', 'Dezoito', 'SÃ£o SebastiÃ£o', 'ParanÃ¡', 'Bela Vista', 'Santa Luzia', 'SÃ£o Jorge',
    'Castro Alves', 'Duque de Caxias', 'Projetada', 'Rui Barbosa', 'Santa Catarina', 'Minas Gerais', 'Santos Dumont',
    'EspÃ­rito Santo', 'Vinte e Um', 'Vinte e Dois', 'da Paz', 'Treze de Maio', 'Rio de Janeiro',
    'GoiÃ¡s', 'CearÃ¡', 'Belo Horizonte', 'das Flores', 'Sergipe', 'VitÃ³ria', 'JosÃ© BonifÃ¡cio',
    'Pernambuco', 'PiauÃ­', 'Vinte e TrÃªs', 'Mato Grosso', 'Santa Maria', 'Dom Pedro II',
    'Primeiro de Maio', 'ParÃ¡', 'MaranhÃ£o', 'Alagoas', 'Boa Vista', 'SÃ£o Luiz', 'Vinte e Quatro', 'ParaÃ­ba', 'Santa Rita'];
...
exports.LOCALIZACAO_BAIRROS = ['Centro', 'Bela Vista', 'SÃ£o JosÃ©', 'Santo AntÃ´nio', 'SÃ£o Francisco', 'Vila Nova',
    'Boa Vista', 'Industrial', 'SÃ£o CristÃ³vÃ£o', 'Planalto'];
exports.LOCALIZACAO_ESTADOS = [
    ...
    { "nome": "EspÃ­rito Santo", "uf": "ES" },
    { "nome": "GoiÃ¡s", "uf": "GO" },
    { "nome": "MaranhÃ£o", "uf": "MA" },
...
exports.LOCALIZACAO_CIDADES = [
    ...
    ['Teresina', 'PiauÃ­'],
    ['SÃ£o Bernardo do Campo', 'SÃ£o Paulo'],
    ['Nova IguaÃ§u', 'Rio de Janeiro'],
    ['JoÃ£o Pessoa', 'ParaÃ­ba'],
    ['SÃ£o JosÃ© dos Campos', 'SÃ£o Paulo'],
    ['Santo AndrÃ©', 'SÃ£o Paulo'],
    ['RibeirÃ£o Preto', 'SÃ£o Paulo'],
    ['JaboatÃ£o dos Guararapes', 'Pernambuco'],
    ['Osasco', 'SÃ£o Paulo'],
    ...
    ['Aparecida de GoiÃ¢nia', 'GoiÃ¡s'],
    ['Londrina', 'ParanÃ¡'],
    ['Juiz de Fora', 'Minas Gerais'],
    ['Ananindeua', 'ParÃ¡'],
    ['Porto Velho', 'RondÃ´nia'],
    ['Serra', 'EspÃ­rito Santo'],
    ...
    ['Vila Velha', 'EspÃ­rito Santo'],
    ['MauÃ¡', 'SÃ£o Paulo'],
    ['SÃ£o JoÃ£o de Meriti', 'Rio de Janeiro'],
    ['SÃ£o JosÃ© do Rio Preto', 'SÃ£o Paulo'],
    ...
    ['CarapicuÃ­ba', 'SÃ£o Paulo'],
    ['Boa Vista', 'Roraima'],
    ['Olinda', 'Pernambuco'],
    ['AnÃ¡polis', 'GoiÃ¡s'],
    ['Cariacica', 'EspÃ­rito Santo'],
    ['Bauru', 'SÃ£o Paulo'],
    ['Itaquaquecetuba', 'SÃ£o Paulo'],
    ['SÃ£o Vicente', 'SÃ£o Paulo'],
    ...
    ['VitÃ³ria da Conquista', 'Bahia'],
    ['RibeirÃ£o das Neves', 'Minas Gerais'],
    ['Uberaba', 'Minas Gerais'],
    ['Paulista', 'Pernambuco'],
    ['Cascavel', 'ParanÃ¡'],
    ['Praia Grande', 'SÃ£o Paulo'],
    ['SÃ£o JosÃ© dos Pinhais', 'ParanÃ¡'],
    ['GuarujÃ¡', 'SÃ£o Paulo'],
    ['TaubatÃ©', 'SÃ£o Paulo'],
    ['PetrÃ³polis', 'Rio de Janeiro'],
    ['Limeira', 'SÃ£o Paulo'],
    ['SantarÃ©m', 'ParÃ¡'],
    ['CamaÃ§ari', 'Bahia'],
    ['Palmas', 'Tocantins'],
    ['Suzano', 'SÃ£o Paulo'],
    ['MossorÃ³', 'Rio Grande do Norte'],
    ['TaboÃ£o da Serra', 'SÃ£o Paulo'],
    ['VÃ¡rzea Grande', 'Mato Grosso'],
    ['SumarÃ©', 'SÃ£o Paulo'],
    ['Santa Maria', 'Rio Grande do Sul'],
    ['GravataÃ­', 'Rio Grande do Sul'],
    ['Governador Valadares', 'Minas Gerais'],
    ['MarabÃ¡', 'ParÃ¡'],
    ['Juazeiro do Norte', 'CearÃ¡'],
    ['Barueri', 'SÃ£o Paulo'],
    ['Embu das Artes', 'SÃ£o Paulo'],
    ['Volta Redonda', 'Rio de Janeiro'],
    ['Ipatinga', 'Minas Gerais'],
    ['Parnamirim', 'Rio Grande do Norte'],
    ['Imperatriz', 'MaranhÃ£o'],
    ['Foz do IguaÃ§u', 'ParanÃ¡'],
    ['MacaÃ©', 'Rio de Janeiro'],
    ['ViamÃ£o', 'Rio Grande do Sul'],
    ['SÃ£o Carlos', 'SÃ£o Paulo'],
    ['Indaiatuba', 'SÃ£o Paulo'],
    ['Cotia', 'SÃ£o Paulo'],
    ['Novo Hamburgo', 'Rio Grande do Sul'],
    ['SÃ£o JosÃ©', 'Santa Catarina'],
    ['MagÃ©', 'Rio de Janeiro'],
    ['Colombo', 'ParanÃ¡'],
    ['ItaboraÃ­', 'Rio de Janeiro'],
    ['Sete Lagoas', 'Minas Gerais'],
    ['Americana', 'SÃ£o Paulo'],
    ['MarÃ­lia', 'SÃ£o Paulo'],
    ['DivinÃ³polis', 'Minas Gerais'],
    ['Itapevi', 'SÃ£o Paulo'],
    ['SÃ£o Leopoldo', 'Rio Grande do Sul'],
    ['Araraquara', 'SÃ£o Paulo'],
    ['Rio Verde', 'GoiÃ¡s'],
    ['JacareÃ­', 'SÃ£o Paulo'],
    ['RondonÃ³polis', 'Mato Grosso'],
    ['Arapiraca', 'Alagoas'],
    ['HortolÃ¢ndia', 'SÃ£o Paulo'],
    ['Presidente Prudente', 'SÃ£o Paulo'],
    ['MaracanaÃº', 'CearÃ¡'],
    ['Dourados', 'Mato Grosso do Sul'],
    ['ChapecÃ³ ChapecÃ³', 'Santa Catarina'],
    ['Cabo Frio', 'Rio de Janeiro'],
    ['ItajaÃ­', 'Santa Catarina'],
    ['Santa Luzia', 'Minas Gerais'],
    ['Juazeiro', 'Bahia'],
    ['CriciÃºma', 'Santa Catarina'],
    ['Itabuna', 'Bahia'],
    ['Ãguas Lindas de GoiÃ¡s', 'GoiÃ¡s'],
    ['Rio Grande', 'Rio Grande do Sul'],
    ['Alvorada', 'Rio Grande do Sul'],
    ['Cachoeiro de Itapemirim', 'EspÃ­rito Santo'],
    ['Sobral', 'CearÃ¡'],
    ['LuziÃ¢nia', 'GoiÃ¡s'],
    ['Parauapebas', 'ParÃ¡'],
    ['Cabo de Santo Agostinho', 'Pernambuco'],
    ['Rio Claro', 'SÃ£o Paulo'],
    ['Angra dos Reis', 'Rio de Janeiro'],
    ['Passo Fundo', 'Rio Grande do Sul'],
    ['Castanhal', 'ParÃ¡'],
    ['Lauro de Freitas', 'Bahia'],
    ['AraÃ§atuba', 'SÃ£o Paulo'],
    ['Ferraz de Vasconcelos', 'SÃ£o Paulo'],
    ['Santa BÃ¡rbara do Oeste', 'SÃ£o Paulo'],
    ['Nova Friburgo', 'Rio de Janeiro'],
    ['Barra Mansa', 'Rio de Janeiro'],
    ['Nossa Senhora do Socorro', 'Sergipe'],
    ['TeresÃ³polis', 'Rio de Janeiro'],
    ['Guarapuava', 'ParanÃ¡'],
    ['AraguaÃ­na', 'Tocantins'],
    ['IbiritÃ©', 'Minas Gerais'],
    ['JaraguÃ¡ do Sul', 'Santa Catarina'],
    ['SÃ£o JosÃ© de Ribamar', 'MaranhÃ£o'],
    ['Mesquita', 'Rio de Janeiro'],
    ['Francisco Morato', 'SÃ£o Paulo'],
    ['Itapecerica da Serra', 'SÃ£o Paulo'],
    ['Itu', 'SÃ£o Paulo'],
    ['Linhares', 'EspÃ­rito Santo'],
    ['PalhoÃ§a', 'Santa Catarina'],
    ['Timon', 'MaranhÃ£o'],
    ['BraganÃ§a Paulista', 'SÃ£o Paulo'],
    ['ValparaÃ­so de GoiÃ¡s', 'GoiÃ¡s'],
    ['Pindamonhangaba', 'SÃ£o Paulo'],
    ['PoÃ§os de Caldas', 'Minas Gerais'],
    ['Caxias', 'MaranhÃ£o'],
    ['Itapetininga', 'SÃ£o Paulo'],
    ['NilÃ³polis', 'Rio de Janeiro'],
    ['IlhÃ©us', 'Bahia'],
    ['MaricÃ¡', 'Rio de Janeiro'],
    ['SÃ£o Caetano do Sul', 'SÃ£o Paulo'],
    ...
    ['Barreiras', 'Bahia'],
    ['ParanaguÃ¡', 'ParanÃ¡'],
    ['Franco da Rocha', 'SÃ£o Paulo'],
    ['ParnaÃ­ba', 'PiauÃ­'],
    ['Patos de Minas', 'Minas Gerais'],
    ['Mogi GuaÃ§u', 'SÃ£o Paulo'],
    ['Alagoinhas', 'Bahia'],
    ...
    ['Sinop', 'Mato Grosso'],
    ['Atibaia', 'SÃ£o Paulo'],
    ['BalneÃ¡rio CamboriÃº', 'Santa Catarina'],
    ['Sapucaia do Sul', 'Rio Grande do Sul'],
    ['Toledo', 'ParanÃ¡'],
    ['TeÃ³filo Otoni', 'Minas Gerais'],
    ['Garanhuns', 'Pernambuco'],
    ['Santana de ParnaÃ­ba', 'SÃ£o Paulo'],
    ['VitÃ³ria de Santo AntÃ£o', 'Pernambuco'],
    ['CametÃ¡', 'ParÃ¡'],
    ...
    ['SÃ£o FÃ©lix do Xingu', 'ParÃ¡'],
    ['BraganÃ§a', 'ParÃ¡'],
    ['Vespasiano', 'Minas Gerais'],
    ['Trindade', 'GoiÃ¡s'],
    ['Uruguaiana', 'Rio Grande do Sul'],
    ['SertÃ£ozinho', 'SÃ£o Paulo'],
    ['Jandira', 'SÃ£o Paulo'],
    ['Guarapari', 'EspÃ­rito Santo'],
    ['Barcarena', 'ParÃ¡'],
    ['Birigui', 'SÃ£o Paulo'],
    ['RibeirÃ£o Pires', 'SÃ£o Paulo'],
    ['Arapongas', 'ParanÃ¡'],
    ['CodÃ³', 'MaranhÃ£o'],
    ['Colatina', 'EspÃ­rito Santo'],
    ['Votorantim', 'SÃ£o Paulo'],
    ['PaÃ§o do Lumiar', 'MaranhÃ£o'],
    ['Barretos', 'SÃ£o Paulo'],
    ['Catanduva', 'SÃ£o Paulo'],
    ['VÃ¡rzea Paulista', 'SÃ£o Paulo'],
    ['GuaratinguetÃ¡', 'SÃ£o Paulo'],
    ['TatuÃ­', 'SÃ£o Paulo'],
    ['Formosa', 'GoiÃ¡s'],
    ['Caraguatatuba', 'SÃ£o Paulo'],
    ['TrÃªs Lagoas', 'Mato Grosso do Sul'],
    ['Santana', 'AmapÃ¡'],
    ['BagÃ©', 'Rio Grande do Sul'],
    ['Itatiba', 'SÃ£o Paulo'],
    ['Bento GonÃ§alves', 'Rio Grande do Sul'],
    ['Itabira', 'Minas Gerais'],
    ['Salto', 'SÃ£o Paulo'],
    ['Almirante TamandarÃ©', 'ParanÃ¡'],
    ['Paulo Afonso', 'Bahia'],
    ['PoÃ¡', 'SÃ£o Paulo'],
    ...
    ['Ourinhos', 'SÃ£o Paulo'],
    ['EunÃ¡polis', 'Bahia'],
    ['SÃ£o LourenÃ§o da Mata', 'Pernambuco'],
    ['Paragominas', 'ParÃ¡'],
    ['Piraquara', 'ParanÃ¡'],
    ['AÃ§ailÃ¢ndia', 'MaranhÃ£o'],
    ['Umuarama', 'ParanÃ¡'],
    ['CorumbÃ¡', 'Mato Grosso do Sul'],
    ['Coronel Fabriciano', 'Minas Gerais'],
    ['PaulÃ­nia', 'SÃ£o Paulo'],
    ['CatalÃ£o', 'GoiÃ¡s'],
    ['MuriaÃ©', 'Minas Gerais'],
    ...
    ['TubarÃ£o', 'Santa Catarina'],
    ['Bacabal', 'MaranhÃ£o'],
    ['Japeri', 'Rio de Janeiro'],
    ['Itumbiara', 'GoiÃ¡s'],
    ['Ituiutaba', 'Minas Gerais'],
    ['SÃ£o Pedro da Aldeia', 'Rio de Janeiro'],
    ['Lagarto', 'Sergipe'],
    ['Assis', 'SÃ£o Paulo'],
    ['Lavras', 'Minas Gerais'],
    ['TangarÃ¡ da Serra', 'Mato Grosso'],
    ['Leme', 'SÃ£o Paulo'],
    ['Itaperuna', 'Rio de Janeiro'],
    ['Breves', 'ParÃ¡'],
    ['Nova Serrana', 'Minas Gerais'],
    ['Iguatu', 'CearÃ¡'],
    ['SÃ£o GonÃ§alo do Amarante', 'Rio Grande do Norte'],
    ['ItanhaÃ©m', 'SÃ£o Paulo'],
    ['Santo AntÃ´nio de Jesus', 'Bahia'],
    ['Caieiras', 'SÃ£o Paulo'],
    ['Itacoatiara', 'Amazonas'],
    ['Itaituba', 'ParÃ¡'],
    ['Aracruz', 'EspÃ­rito Santo'],
    ['JataÃ­', 'GoiÃ¡s'],
    ['Barra do PiraÃ­', 'Rio de Janeiro'],
    ['Fazenda Rio Grande', 'ParanÃ¡'],
    ['MairiporÃ£', 'SÃ£o Paulo']
];
...
exports.PLACAS_RANGE = [
    { start: 'AAA0001', end: 'BEZ9999', state: '', desc: 'ParanÃ¡]] (PR)', since: '02/1990' },
    { start: 'BFA0001', end: 'GKI9999', state: '', desc: 'SÃ£o Paulo (estado)|SÃ£o Paulo]] (SP)', since: '10/1991' },
    { start: 'GKJ0001', end: 'HOK9999', state: '', desc: 'Minas Gerais]] (MG)', since: '09/1991' },
    { start: 'HOL0001', end: 'HQE9999', state: '', desc: 'MaranhÃ£o]] (MA)', since: '01/1992' },
    { start: 'HQF0001', end: 'HTW9999', state: '', desc: 'Mato Grosso do Sul]] (MS)', since: '03/1992' },
    { start: 'HTX0001', end: 'HZA9999', state: '', desc: 'CearÃ¡]] (CE)', since: '10/1992' },
    ...
    { start: 'JTA0001', end: 'JWE9999', state: '', desc: 'ParÃ¡]] (PA)', since: '07/1993' },
    ...
    { start: 'KAV0001', end: 'KFC9999', state: '', desc: 'GoiÃ¡s]] (GO)', since: '05/1994' },
    ...
    { start: 'LVF0001', end: 'LWQ9999', state: '', desc: 'PiauÃ­]] (PI)', since: '04/1996' },
    { start: 'LWR0001', end: 'MMM9999', state: '', desc: 'Santa Catarina]] (SC)', since: '06/1996' },
    { start: 'MMN0001', end: 'MOW9999', state: '', desc: 'ParaÃ­ba]] (PB)', since: '07/1996' },
    { start: 'MOX0001', end: 'MTZ9999', state: '', desc: 'EspÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES)', since: '12/1995' },
    ...
    { start: 'NBB0001', end: 'NEH9999', state: '', desc: 'RondÃ´nia]] (RO)', since: '07/1998' },
    { start: 'NEI0001', end: 'NFB9999', state: '', desc: 'AmapÃ¡]] (AP)', since: '09/1998' },
    { start: 'NFC0001', end: 'NGZ9999', state: '', desc: 'GoiÃ¡s]] (GO) 2Âª sequÃªncia', since: '08/2003' },
    { start: 'NHA0001', end: 'NHT9999', state: '', desc: 'MaranhÃ£o]] (MA) 2Âª sequÃªncia', since: '12/2006' },
    { start: 'NHU0001', end: 'NIX9999', state: '', desc: 'PiauÃ­]] (PI) 2Âª sequÃªncia', since: '05/2007' },
    { start: 'NIY0001', end: 'NJW9999', state: '', desc: 'Mato Grosso]] (MT) 2Âª sequÃªncia', since: '10/2007' },
    { start: 'NJX0001', end: 'NLU9999', state: '', desc: 'GoiÃ¡s]] (GO) 3Âª sequÃªncia', since: '11/2007' },
    { start: 'NLV0001', end: 'NMO9999', state: '', desc: 'Alagoas]] (AL) 2Âª sequÃªncia', since: '01/2008' },
    { start: 'NMP0001', end: 'NNI9999', state: '', desc: 'MaranhÃ£o]] (MA) 3Âª sequÃªncia', since: '05/2008' },
    { start: 'NNJ0001', end: 'NOH9999', state: '', desc: 'Rio Grande do Norte]] (RN) 2Âª sequÃªncia', since: '07/2008' },
    { start: 'NOI0001', end: 'NPB9999', state: '', desc: 'Amazonas]] (AM) 2Âª sequÃªncia', since: '07/2008' },
    { start: 'NPC0001', end: 'NPQ9999', state: '', desc: 'Mato Grosso]] (MT) 3Âª sequÃªncia', since: '09/2008' },
    { start: 'NPR0001', end: 'NQK9999', state: '', desc: 'ParaÃ­ba]] (PB) 2Âª sequÃªncia', since: '11/2008' },
    { start: 'NQL0001', end: 'NRE9999', state: '', desc: 'CearÃ¡]] (CE) 2Âª sequÃªncia', since: '12/2008' },
    { start: 'NRF0001', end: 'NSD9999', state: '', desc: 'Mato Grosso do Sul]] (MS) 2Âª sequÃªncia', since: '11/2009' },
    { start: 'NSE0001', end: 'NTC9999', state: '', desc: 'ParÃ¡]] (PA) 2Âª sequÃªncia', since: '11/2009' },
    { start: 'NTD0001', end: 'NTW9999', state: '', desc: 'Bahia]] (BA) 2Âª sequÃªncia', since: '02/2010' },
    { start: 'NTX0001', end: 'NUG9999', state: '', desc: 'Mato Grosso]] (MT) 4Âª sequÃªncia', since: '03/2010' },
    { start: 'NUH0001', end: 'NUL9999', state: '', desc: 'Roraima]] (RR) 2Âª sequÃªncia', since: '06/2010' },
    { start: 'NUM0001', end: 'NVF9999', state: '', desc: 'CearÃ¡]] (CE) 3Âª sequÃªncia', since: '06/2010' },
    { start: 'NVG0001', end: 'NVN9999', state: '', desc: 'Sergipe]] (SE) 2Âª sequÃªncia', since: '03/2010' },
    { start: 'NVO0001', end: 'NWR9999', state: '', desc: 'GoiÃ¡s]] (GO) 4Âª sequÃªncia', since: '03/2010' },
    { start: 'NWS0001', end: 'NXQ9999', state: '', desc: 'MaranhÃ£o]] (MA) 4Âª sequÃªncia', since: '07/2010' },
    { start: 'NXR0001', end: 'NXT9999', state: '', desc: 'Acre]] (AC) 2Âª sequÃªncia', since: '05/2011' },
    { start: 'NXU0001', end: 'NXW9999', state: '', desc: 'Pernambuco]] (PE) 2Âª sequÃªncia', since: '07/2010' },
    { start: 'NXX0001', end: 'NYG9999', state: '', desc: 'Minas Gerais]] (MG) 2Âª sequÃªncia', since: '10/2011' },
    { start: 'NYH0001', end: 'NZZ9999', state: '', desc: 'Bahia]] (BA) 3Âª sequÃªncia', since: '10/2010' },
    { start: 'OAA0001', end: 'OAO9999', state: '', desc: 'Amazonas]] (AM) 3Âª sequÃªncia', since: '12/2010' },
    { start: 'OAP0001', end: 'OBS9999', state: '', desc: 'Mato Grosso]] (MT) 5Âª sequÃªncia', since: '05/2011' },
    { start: 'OBT0001', end: 'OCA9999', state: '', desc: 'ParÃ¡]] (PA) 3Âª sequÃªncia', since: '07/2011' },
    { start: 'OCB0001', end: 'OCU9999', state: '', desc: 'CearÃ¡]] (CE) 4Âª sequÃªncia', since: '02/2011' },
    { start: 'OCV0001', end: 'ODT9999', state: '', desc: 'spÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 2Âª sequÃªnci', since: '05/2011' },
    { start: 'ODU0001', end: 'OEI9999', state: '', desc: 'PiauÃ­]] (PI) 3Âª sequÃªncia', since: '09/2011' },
    { start: 'OEJ0001', end: 'OES9999', state: '', desc: 'Sergipe]] (SE) 3Âª sequÃªncia', since: '08/2011' },
    { start: 'OET0001', end: 'OFH9999', state: '', desc: 'ParaÃ­ba]] (PB) 3Âª sequÃªncia', since: '04/2011' },
    { start: 'OFI0001', end: 'OFW9999', state: '', desc: 'ParÃ¡]] (PA) 4Âª sequÃªncia', since: '03/2011' },
    { start: 'OFX0001', end: 'OGG9999', state: '', desc: 'ParaÃ­ba]] (PB) 4Âª sequÃªncia', since: '06/2011' },
    { start: 'OGH0001', end: 'OHA9999', state: '', desc: 'GoiÃ¡s]] (GO) 5Âª sequÃªncia', since: '04/2011' },
    { start: 'OHB0001', end: 'OHK9999', state: '', desc: 'Alagoas]] (AL) 3Âª sequÃªncia', since: '09/2011' },
    { start: 'OHL0001', end: 'OHW9999', state: '', desc: 'RondÃ´nia]] (RO) 2Âª sequÃªncia', since: '11/2011' },
    { start: 'OHX0001', end: 'OIQ9999', state: '', desc: 'CearÃ¡]] (CE) 5Âª sequÃªncia', since: '12/2011' },
    { start: 'OIR0001', end: 'OJQ9999', state: '', desc: 'MaranhÃ£o]] (MA) 5Âª sequÃªncia', since: '01/2012' },
    { start: 'OJR0001', end: 'OKC9999', state: '', desc: 'Rio Grande do Norte]] (RN) 3Âª sequÃªncia', since: '04/2012' },
    { start: 'OKD0001', end: 'OKH9999', state: '', desc: 'Santa Catarina]] (SC) 2Âª sequÃªncia', since: '02/2014' },
    { start: 'OKI0001', end: 'OLG9999', state: '', desc: 'Bahia]] (BA) 4Âª sequÃªncia', since: '10/2011' },
    { start: 'OLH0001', end: 'OLN9999', state: '', desc: 'Tocantins]] (TO) 2Âª sequÃªncia', since: '02/2012' },
    { start: 'OLO0001', end: 'OMH9999', state: '', desc: 'Minas Gerais]] (MG) 3Âª sequÃªncia', since: '03/2012' },
    { start: 'OMI0001', end: 'OOF9999', state: '', desc: 'GoiÃ¡s]] (GO) 6Âª sequÃªncia', since: '04/2012' },
    { start: 'OOG0001', end: 'OOU9999', state: '', desc: 'Mato Grosso do Sul]] (MS) 3Âª sequÃªncia', since: '02/2012' },
    { start: 'OOV0001', end: 'ORC9999', state: '', desc: 'Minas Gerais]] (MG) 4Âª sequÃªncia', since: '06/2012' },
    { start: 'ORD0001', end: 'ORM9999', state: '', desc: 'Alagoas]] (AL) 4ÂªsequÃªncia', since: '01/2012' },
    { start: 'ORN0001', end: 'OSV9999', state: '', desc: 'CearÃ¡]] (CE) 6Âª sequÃªncia', since: '07/2012' },
    { start: 'OSW0001', end: 'OTZ9999', state: '', desc: 'ParÃ¡]] (PA) 5Âª sequÃªncia', since: '08/2012' },
    { start: 'OUA0001', end: 'OUE9999', state: '', desc: 'PiauÃ­]] (PI) 4Âª sequÃªncia', since: '11/2012' },
    { start: 'OUF0001', end: 'OVD9999', state: '', desc: 'Bahia]] (BA) 5Âª sequÃªncia', since: '12/2012' },
    { start: 'OVE0001', end: 'OVF9999', state: '', desc: 'spÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 3Âª sequÃªnci', since: '12/2012' },
    { start: 'OVG0001', end: 'OVG9999', state: '', desc: 'Acre]] (AC) 3Âª sequÃªncia', since: '05/2013' },
    { start: 'OVH0001', end: 'OVL9999', state: '', desc: 'spÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 4Âª sequÃªnci', since: '07/2013' },
    { start: 'OVM0001', end: 'OVV9999', state: '', desc: 'Distrito Federal]] (DF) 2Âª sequÃªncia', since: '11/2013' },
    { start: 'OVW0001', end: 'OVY9999', state: '', desc: 'PiauÃ­]] (PI) 5Âª sequÃªncia', since: '10/2013' },
    { start: 'OVZ0001', end: 'OWG9999', state: '', desc: 'Rio Grande do Norte]] (RN) 4Âª sequÃªncia', since: '06/2013' },
    { start: 'OWH0001', end: 'OXK9999', state: '', desc: 'Minas Gerais]] (MG) 5Âª sequÃªncia', since: '10/2013' },
    { start: 'OXL0001', end: 'OXL9999', state: '', desc: 'RondÃ´nia]] (RO) 3Âª sequÃªncia', since: '11/2013' },
    { start: 'OXM0001', end: 'OXM9999', state: '', desc: 'Amazonas]] (AM) 4Âª sequÃªncia', since: '11/2013' },
    { start: 'OXN0001', end: 'OXN9999', state: '', desc: 'Alagoas]] (AL) 5Âª sequÃªncia', since: '11/2013' },
    { start: 'OXO0001', end: 'OXO9999', state: '', desc: 'ParaÃ­ba]] (PB) 5Âª sequÃªncia', since: '11/2013' },
    { start: 'OXP0001', end: 'OXP9999', state: '', desc: 'Acre]] (AC) 4Âª sequÃªncia', since: '12/2013' },
    { start: 'OXQ0001', end: 'OXZ9999', state: '', desc: 'MaranhÃ£o]] (MA) 6Âª sequÃªncia', since: '04/2014' },
    { start: 'OYA0001', end: 'OYC9999', state: '', desc: 'Tocantins]] (TO) 3Âª sequÃªncia', since: '11/2013' },
    { start: 'OYD0001', end: 'OYK9999', state: '', desc: 'spÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 5Âª sequÃªnci', since: '12/2013' },
    { start: 'OYL0001', end: 'OYZ9999', state: '', desc: 'Pernambuco]] (PE) 6Âª sequÃªncia', since: '02/2014' },
    { start: 'OZA0001', end: 'OZA9999', state: '', desc: 'CearÃ¡]] (CE) 7Âª sequÃªncia', since: '01/2014' },
    { start: 'OZB0001', end: 'OZB9999', state: '', desc: 'Sergipe]] (SE) 4Âª sequÃªncia', since: '01/2014' },
    { start: 'OZC0001', end: 'OZV9999', state: '', desc: 'Bahia]] (BA) 6Âª sequÃªncia', since: '03/2014' },
    { start: 'OZW0001', end: 'PBZ9999', state: '', desc: 'Distrito Federal]] (DF) 3Âª sequÃªncia', since: '05/2014' },
    { start: 'PCA0001', end: 'PED9999', state: '', desc: 'Pernambuco]] (PE) 7Âª sequÃªncia', since: '12/2014' },
    { start: 'PEE0001', end: 'PFQ9999', state: '', desc: 'Pernambuco]] (PE) 3Âª sequÃªncia', since: '09/2010' },
    { start: 'PFR0001', end: 'PGK9999', state: '', desc: 'Pernambuco]] (PE) 4Âª sequÃªncia', since: '07/2012' },
    { start: 'PGL0001', end: 'PGU9999', state: '', desc: 'Pernambuco]] (PE) 5Âª sequÃªncia', since: '10/2013' },
    { start: 'PGV0001', end: 'PGZ9999', state: '', desc: 'Pernambuco]] (PE) 8Âª sequÃªncia', since: '12/2014' },
    { start: 'PHA0001', end: 'PHZ9999', state: '', desc: 'Amazonas]] (AM) 5Âª sequÃªncia', since: '06/2014' },
    { start: 'PIA0001', end: 'PIZ9999', state: '', desc: 'PiauÃ­]] (PI) 6Âª sequÃªncia', since: '06/2014' },
    { start: 'PJA0001', end: 'PLZ9999', state: '', desc: 'Bahia]] (BA) 7Âª sequÃªncia', since: '10/2014' },
    { start: 'PMA0001', end: 'POZ9999', state: '', desc: 'CearÃ¡]] (CE) 8Âª sequÃªncia', since: '06/2014' },
    { start: 'PPA0001', end: 'PPZ9999', state: '', desc: 'spÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 6Âª sequÃªnci', since: '08/2014' },
    { start: 'PQA0001', end: 'PRZ9999', state: '', desc: 'GoiÃ¡s]] (GO) 7Âª sequÃªncia', since: '03/2015' },
    { start: 'PSA0001', end: 'PTZ9999', state: '', desc: 'MaranhÃ£o]] (MA) 7Âª sequÃªncia', since: '12/2014' },
    { start: 'PUA0001', end: 'PZZ9999', state: '', desc: 'Minas Gerais]] (MG) 6Âª sequÃªncia', since: '05/2014' },
    { start: 'QAA0001', end: 'QAZ9999', state: '', desc: 'Mato Grosso do Sul]] (MS) 4Âª sequÃªncia', since: '12/2014' },
    { start: 'QBA0001', end: 'QCZ9999', state: '', desc: 'Mato Grosso]] (MT) 6Âª sequÃªncia', since: '05/2014' },
    { start: 'QDA0001', end: 'QEZ9999', state: '', desc: 'ParÃ¡]] (PA) 6Âª sequÃªncia', since: '10/2014' },
    { start: 'QFA0001', end: 'QFZ9999', state: '', desc: 'ParaÃ­ba]] (PB) 6Âª sequÃªncia', since: '05/2014' },
    { start: 'QGA0001', end: 'QGZ9999', state: '', desc: 'Rio Grande do Norte]] (RN) 5Âª sequÃªncia', since: '09/2014' },
    { start: 'QHA0001', end: 'QJZ9999', state: '', desc: 'Santa Catarina]] (SC) 3Âª sequÃªncia', since: '05/2014' },
    { start: 'QKA0001', end: 'QKM9999', state: '', desc: 'Tocantins]] (TO) 4Âª sequÃªncia', since: '11/2014' },
    { start: 'QKN0001', end: 'QKZ9999', state: '', desc: 'Sergipe]] (SE) 5Âª sequÃªncia', since: '06/2014' },
    { start: 'QLA0001', end: 'QLM9999', state: '', desc: 'Alagoas]] (AL) 6Âª sequÃªncia', since: '09/2015' },
    { start: 'QLN0001', end: 'QLT9999', state: '', desc: 'AmapÃ¡]] (AP) 2Âª sequÃªncia', since: '01/2015' },
    { start: 'QLU0001', end: 'QLZ9999', state: '', desc: 'Acre]] (AC) 5Âª sequÃªncia', since: '08/2014' },
    { start: 'QMA0001', end: 'QMP9999', state: '', desc: 'Sergipe]] (SE) 6Âª sequÃªncia', since: '03/2017' },
    { start: 'QMQ0001', end: 'QQZ9999', state: '', desc: 'Minas Gerais]] (MG) 7Âª sequÃªncia ', since: '07/2017' },
    { start: 'QRA0001', end: 'QRA9999', state: '', desc: 'RondÃ´nia]] (RO) 4Âª sequÃªncia', since: '11/2017' },
    { start: 'QRB0001', end: 'QRZ9999', state: '', desc: 'EspÃ­rito Santo (estado)|EspÃ­rito Santo]] (ES) 7Âª sequÃªncia', since: '05/2018' },
    { start: 'QSA0001', end: 'QSZ9999', state: '', desc: 'ParaÃ­ba]] (PB) 7Âª sequÃªncia', since: '04/2018' },
    { start: 'QTA0001', end: 'QTB9999', state: '', desc: 'RondÃ´nia]] (RO) 5Âª sequÃªncia', since: '08/2018' },
    { start: 'QTC0001', end: 'RIN9999', state: '', desc: 'quÃªn', since: 'inidas ' },
    { start: 'RIO0001', end: 'RIO9999', state: '', desc: 'Rio de Janeiro (estado)|Rio de Janeiro]] (RJ) 2Âª sequÃªncia ', since: '9/2018}' },
    { start: 'RLA0001', end: 'SAU9999', state: '', desc: 'equÃªn', since: 'inidas ' },
    { start: 'SAV0001', end: 'SAV9999', state: '', desc: 'Ã£o Paulo (estado)|SÃ£o Paulo]] (SP) 2Âº sequÃªncia', since: '09/2009' },
];
exports.PLACAS_INVALID = { start: 'SAW0001', end: 'ZZZ9999' }; // || SequÃªncias ainda nÃ£o definidas
...
function rg_sp(number) {
    // if(number.length>8){alert("Erro. NÃ£o existe RG SP\ncom mais de 8 dÃ­gitos.");}
    number = "0000000" + number;
    number = number.slice(number.length - 8);
    var b1 = parseInt(number.slice(7));
    var b2 = parseInt(number.slice(6, 7));
...
function rg_rj(number) {
    // if(number.length>8){alert("Erro. NÃ£o existe RG-RJ/MaSP-MG\ncom mais de 8 dÃ­gitos.");}
    number = "0000000" + number;
    number = number.slice(number.length - 8);
    var b1 = parseInt(number.slice(7));
    var b2 = parseInt(number.slice(6, 7));
...
function slugify(value) {
    return value.toString().toLowerCase()
        .replace(/[Ã Ã€Ã¡ÃÃ¢Ã‚Ã£Ã¤Ã„Ã…Ã¥Âª]+/g, 'a') // Special Characters #1
        .replace(/[Ã¨ÃˆÃ©Ã‰ÃªÃŠÃ«Ã‹]+/g, 'e') // Special Characters #2
        .replace(/[Ã¬ÃŒÃ­ÃÃ®ÃŽÃ¯Ã]+/g, 'i') // Special Characters #3
        .replace(/[Ã²Ã’Ã³Ã“Ã´Ã”ÃµÃ•Ã¶Ã–Âº]+/g, 'o') // Special Characters #4
        .replace(/[Ã¹Ã™ÃºÃšÃ»Ã›Ã¼Ãœ]+/g, 'u') // Special Characters #5
        .replace(/[Ã½ÃÃ¿Å¸]+/g, 'y') // Special Characters #6
        .replace(/[Ã±Ã‘]+/g, 'n') // Special Characters #7
        .replace(/[Ã§Ã‡]+/g, 'c') // Special Characters #8
        .replace(/[ÃŸ]+/g, 'ss') // Special Characters #9
        .replace(/[Ã†Ã¦]+/g, 'ae') // Special Characters #10
        .replace(/[Ã˜Ã¸Å“]+/g, 'oe') // Special Characters #11
...
function validate_cns(value) {
    ...
    var definitivo = /[1-2][0-9]{10}00[0-1][0-9]/; // comeÃ§am com 1 ou 2
    var provisorio = /[7-9][0-9]{14}/; // comeÃ§am com 7,8 ou 9
...
exports.VEICULOS_CARROCERIAS = ["AMBULÃ‚NCIA", "BASCULANTE", "BLINDADA", "BUGGY", "C. FECHADA", "CAB. DUPLA", "CAB. ABERTA",
    "CONVERSÃVEL", "FURGÃƒO", "JIPE", "TRAILER"];
exports.VEICULOS_CATEGORIAS = ["ALUGUEL", "APRENDIZAGEM", "PARTICULAR"];
exports.VEICULOS_TIPOS = ["AUTOMÃ“VEL", "CAMINHÃƒO", "CAMINHONETA", "CARGA / CAM", "CICLOMOTO", "ESP / Ã”NIBUS", "MICROÃ”NIBUS",
    "MISTO / CAM", "MOTOCICLO", "MOTONETA", "Ã”NIBUS", "REBOQUE", "TRICICLO", "C. TRATOR"];
exports.VEICULOS_COMBUSTIVEIS = ["ÃLCOOL", "ÃLCOOL / GNC", "DIESEL", "DIESEL / GNC", "ELFONT EX", "ELFONT IN", "GÃS METANO",
    "GASOGÃŠNIO", "GASOL / GNC", "GASOLINA", "ÃLCOOL / GASOLINA", "ÃLCOOL / GASOL / GNV"];
exports.VEICULOS_RESTRICOES = ["ALIENAÃ‡ÃƒO FIDUCIÃRIA", "ARRENDAMENTO", "RESERVA DE DOMÃNIO", "RESTRIÃ‡ÃƒO JUDICIAL",
    "RESTRIÃ‡ÃƒO POR BENEF. TRIBUTÃRIO", "RESTRIÃ‡ÃƒO POR ROUBO OU FURTO"];
exports.VEICULOS_ESPECIES = ["CARGA", "CORRIDA", "ESPECIAL", "MISTO", "PASSAGEIRO", "TRAÃ‡ÃƒO"];
exports.VEICULOS = [
    ...
    { "modelo": "i3 Rex E Drive Full 170cv Aut.(ElÃ©trico)", "marca": "BMW" },
    ...
    { "modelo": "AIRCROSS Exc. ATACA. 1.6 Flex 16V 5p Aut", "marca": "CitroÃ«n" },
    { "modelo": "AX GTi", "marca": "CitroÃ«n" },
    { "modelo": "C3 XTR 1.6 Flex 16V 5p", "marca": "CitroÃ«n" },
    { "modelo": "C4 Tendance 2.0 Flex 16V 5p Aut.", "marca": "CitroÃ«n" },
    { "modelo": "DS3 1.6 Turbo 16V 3p Mec.", "marca": "CitroÃ«n" },
    { "modelo": "Evasion  GLX 2.0 16V", "marca": "CitroÃ«n" },
    { "modelo": "Grand C4 Picasso Intensive 1.6 TB Aut.", "marca": "CitroÃ«n" },
    { "modelo": "Jumper 2.3 15/16Lug. TB Diesel", "marca": "CitroÃ«n" },
    { "modelo": "Xantia 2.0  16V", "marca": "CitroÃ«n" },
    { "modelo": "Xsara Break Exclusive 1.6 16V 5p Aut.", "marca": "CitroÃ«n" },
    { "modelo": "ZX CupÃª 16V", "marca": "CitroÃ«n" },
    ...
    { "modelo": "Uno FurgÃ£o 1.5/ 1.3", "marca": "Fiat" },
    ...
    { "modelo": "Escort XR3 2.0i ConversÃ­vel", "marca": "Ford" },
    ...
    { "modelo": "Mustang GT V8 ConversÃ­vel", "marca": "Ford" },
    ...
    { "modelo": "Chevy 500 DL / SL / SE/ FurgÃ£o 1.6", "marca": "GM - Chevrolet" },
    ...
    { "modelo": "Corsa FurgÃ£o 1.6 MPFi Powertech 92cv", "marca": "GM - Chevrolet" },
    ...
    { "modelo": "SpaceVan FurgÃ£o 2.1 Diesel", "marca": "GM - Chevrolet" },
    ...
    { "modelo": "CoupÃª FX 2.0 Aut.", "marca": "Hyundai" },
    ...
    { "modelo": "Santa FÃ© /GLS 3.3 V6 4X4 Tiptronic", "marca": "Hyundai" },
    ...
    { "modelo": "Space Wagon GLXi 2.4 ( Nova SÃ©rie )", "marca": "Mitsubishi" },
    ...
    { "modelo": "Boxer 2.3 Furg.TB Dies. Curto/MÃ©dio", "marca": "Peugeot" },
    ...
    { "modelo": "Laguna Grand Tour PrivilÃ¨ge 3.0 V6 210cv", "marca": "Renault" },
    ...
    { "modelo": "ScÃ©nic RXE 2.0 8V", "marca": "Renault" },
